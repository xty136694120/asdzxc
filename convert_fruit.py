...
classes = ['apple','banana','orange','pear', 'pomegranate', 'lemon',
           'mango', 'carambola', 'green pear', 'mandarin orange', 'green mandarin orange', 'red delicious apple'] #对应里面的name，按照实际情况修改 这里由于xml文件和.yaml顺序不一 所以调整一下
Annotation_path = 'E:\\YOLOv3\\archive\\train\\Annotations'
Labels_path = 'E:\\YOLOv3\\archive\\train\\Labels'
Image_path = 'E:\\YOLOv3\\archive\\train\\Images'
